...
describe UsersController do
  describe "update profile" do
    ...
    it "should update the user record" do
      patch :profile_update, params: {profile: {major: "computer science", grad_year: DateTime.new(2022), pronouns: "He/Him/His", identities: "something"} }
      @student.reload
      expect(@student.major).to eq "computer science"
      expect(@student.grad_year).to eq DateTime.new(2022, 01, 01)
